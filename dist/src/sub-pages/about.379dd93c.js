...
anime.timeline({
 ...
 //   document.documentElement.classList.remove("is-animating");
 // }, 100);
 // const slide = new SwupSlideTheme({
 //   reversed: true
 // });
 // const swup = new Swup({
 //   plugins: [slide]
 ...
 //   document.documentElement.classList.remove("is-animating");
 // }, 100);
 // const overlay = new SwupOverlayTheme({
 //   color: "linear-gradient(to right,black 50%, teal 50%)",
 //   duration: 1300,
 //   direction: "to-bottom"
 // });
 // const swup = new Swup({
...
},{}]},["lBB98","hD4hw"], "hD4hw", "parcelRequire16ea")

//# sourceMappingURL=about.379dd93c.js.map
